...
# ssm452基于ssm+vue的在线听书网站+vue

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1t58veLEnL?p=50)
...
第四章：这个章节主要绘制出了系统功能架构，让我们更直观了解在线听书网站的功能，对后台数据库表进行了设计，还画出了对应的Ｅ－Ｒ图。
...
![书籍收藏](/md/blog.010.jpeg "书籍收藏")
图4.3 书籍收藏实体属性图

（4）下图是书籍资讯实体和其具备的属性。

![书籍资讯](/md/blog.011.jpeg "书籍资讯")
图4.4 书籍资讯实体属性图

（5）下图是书籍留言实体和其具备的属性。

![书籍留言](/md/blog.012.jpeg "书籍留言")
图4.5 书籍留言实体属性图

（6）下图是书籍实体和其具备的属性。

![书籍](/md/blog.013.jpeg "书籍")
图4.6 书籍实体属性图
...
|5|shuji\_types|Integer|书籍分类|是|
|6|shuji\_file|String|书籍文件|是|
|7|shuji\_music|String|音频|是|
|8|shuji\_clicknum|Integer|点击次数|是|
|9|shangxia\_types|Integer|是否上架|是|
|10|shuji\_delete|Integer|逻辑删除|是|
|11|shuji\_content|String|书籍介绍|是|
